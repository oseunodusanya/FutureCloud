...
import { columns } from "../delete/delete-columns";
...
export default function DeletePage() {
    ...
    userId = user.isLoaded ? user.user?.id : undefined;
    const userName = user.isLoaded ? user.user?.fullName : undefined;
    ...
    return (
        ...
        <main className="container mx-auto pt-12">
            ...
            <div className="flex justify-between items-center font-bold">
                ...
                <p>Click the delete button if you wish to delete a file</p>
            </div>
            {files ? (
